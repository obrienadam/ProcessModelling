...
public:
    ...
    void retranslateUi(QDialog *BlockDialog)
    {
        ...
        ___qtreewidgetitem3->setText(0, QApplication::translate("BlockDialog", "Flow control", 0));
        QTreeWidgetItem *___qtreewidgetitem4 = ___qtreewidgetitem3->child(0);
        ___qtreewidgetitem4->setText(0, QApplication::translate("BlockDialog", "Valve", 0));
        QTreeWidgetItem *___qtreewidgetitem5 = blockTreeWidget->topLevelItem(2);
        ___qtreewidgetitem5->setText(0, QApplication::translate("BlockDialog", "Reservoirs", 0));
        QTreeWidgetItem *___qtreewidgetitem6 = ___qtreewidgetitem5->child(0);
        ___qtreewidgetitem6->setText(0, QApplication::translate("BlockDialog", "Pressure Reservoir", 0));
        QTreeWidgetItem *___qtreewidgetitem7 = ___qtreewidgetitem5->child(1);
        ___qtreewidgetitem7->setText(0, QApplication::translate("BlockDialog", "Mass Flow Reservoir", 0));
        QTreeWidgetItem *___qtreewidgetitem8 = blockTreeWidget->topLevelItem(3);
        ___qtreewidgetitem8->setText(0, QApplication::translate("BlockDialog", "Connectors", 0));
        QTreeWidgetItem *___qtreewidgetitem9 = ___qtreewidgetitem8->child(0);
        ___qtreewidgetitem9->setText(0, QApplication::translate("BlockDialog", "Diffuser", 0));
        QTreeWidgetItem *___qtreewidgetitem10 = ___qtreewidgetitem8->child(1);
        ___qtreewidgetitem10->setText(0, QApplication::translate("BlockDialog", "Nozzle", 0));
        QTreeWidgetItem *___qtreewidgetitem11 = ___qtreewidgetitem8->child(2);
        ___qtreewidgetitem11->setText(0, QApplication::translate("BlockDialog", "T Connector", 0));
        QTreeWidgetItem *___qtreewidgetitem12 = ___qtreewidgetitem8->child(3);
        ___qtreewidgetitem12->setText(0, QApplication::translate("BlockDialog", "Y Connector", 0));
